...
public class ExecuteAllQueries {
	...
	public static void main(String[] args) throws IOException {
	  ...
	  final PrintWriter w = new PrintWriter(new FileWriter("/home/gchandia/Thesis/NoCacheFinal_4_NoSERVICE.txt"));
	  //final PrintWriter w = new PrintWriter(new FileWriter("D:\\Thesis\\NoCacheFinal.txt"));
	  
	  final PrintWriter er = new PrintWriter(new FileWriter("/home/gchandia/Thesis/NoCacheFinalErrors_4_NoSERVICE.txt"));
